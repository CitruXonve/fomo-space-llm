...
def apply_langchain_anthropic_patch() -> None:
    ...
    def _patched(self: Any, event: Any, *, stream_usage: bool = True, coerce_content_to_string: bool = False, block_start_event: Any = None):  # noqa: E501
        try:
            return original(
                self,
                event,
    ...
    chat_models.ChatAnthropic._make_message_chunk_from_anthropic_event = _patched
